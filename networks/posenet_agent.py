...
def get_ckpt_and_writer_path(cfg):
        ...
        ckpt_path = f'./results/{cfg.log_dir}'
...
class PoseNet(nn.Module):
    ...
    # def load_epoch(self):
    #     load_path = '/home/datasets/GenPose2/results/ScoreNet/ckpt_epoch7.pth'
    ...
    def collect_score_loss(self, data, teacher_model=None, pts_feat_teacher=None):
        ...
        for _ in range(self.cfg.repeat_num):
            ...
            # 累加每个损失分量
            gf_loss_rot += loss_dict['rot']
            gf_loss_len += loss_dict['len']
            gf_loss_tra += loss_dict['tra']

        # 计算每个损失分量的平均值
        gf_loss_rot /= self.cfg.repeat_num
        gf_loss_len /= self.cfg.repeat_num
        gf_loss_tra /= self.cfg.repeat_num
